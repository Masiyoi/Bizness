...
const C = {
  ...
  wishlist:     '#5DADE2', // Add to Wishlist — light blue
  wishlistDark: '#3B97D3',
};
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      <button
        ...
        style={{
          width: '100%', padding: '13px 0',
          border: stock === 0 ? 'none' : inCart ? 'none' : `1px solid ${C.ink}`,
          borderRadius: 10, cursor: stock === 0 ? 'not-allowed' : 'pointer',
          fontFamily: MONO, fontSize: 10, fontWeight: 600,
          letterSpacing: '1.5px', textTransform: 'uppercase',
          background: stock === 0 ? '#EDEDED' : inCart ? C.ink : C.paper,
          color:      stock === 0 ? '#AAAAAA' : inCart ? C.paper : C.ink,
        }}
      >
      ...
      <button
        ...
        style={{
          ...
          background: inWishlist ? C.wishlist : C.paper,
      ...
      >
        <img
          ...
          style={{
            ...
            filter: inWishlist ? 'brightness(0) invert(1)' : 'none',
          }}
        />
