...
// ─────────────────────────────────────────────────────────────────────────────
export type Tab = 'overview' | 'analytics' | 'products' | 'orders' | 'customers' | 'discounts' | 'reviews' | 'members' | 'reports' | 'affiliate' | 'activity';
...
export const NAV_ITEMS: NavItem[] = [
  { id: 'overview',   icon: '/admin/overview.png',            label: 'Overview'   },
  { id: 'analytics',  icon: '/admin/analytic.png',            label: 'Analytics'  },
  { id: 'products',   icon: '/admin/products.png',            label: 'Products'   },
  { id: 'orders',     icon: '/admin/Orders.png',              label: 'Orders'     },
  { id: 'customers',  icon: '/admin/customers.png',           label: 'Customers'  },
  { id: 'discounts',  icon: '/admin/discounts.png',           label: 'Discounts'  },
  { id: 'reviews',    icon: '/admin/star.png',                label: 'Reviews'    },
