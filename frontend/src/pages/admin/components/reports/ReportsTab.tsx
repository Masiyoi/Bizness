...
export function ReportsTab({ showToast }: ReportsTabProps) {
  ...
  const TABS: { id: ReportType; label: string; icon: string; desc: string }[] = [
    { id: 'sales',     label: 'Sales Report',     icon: '/salesreport.png',          desc: 'Order-level revenue & profit by date range' },
    { id: 'inventory', label: 'Inventory Report',  icon: '/inventory-management.png', desc: 'Stock levels, retail value & cost valuation' },
    { id: 'profit',    label: 'Profit Report',     icon: '/profit.png',               desc: 'Product-level profit margin analysis' },
  ];
    ...
    <div className="fade-up">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10, marginBottom: 28 }}>
        {TABS.map(t => (
          ...
          >
            <img src={t.icon} alt={t.label} style={{ width: 22, height: 22, objectFit: 'contain', marginBottom: 8, filter: active === t.id ? 'invert(1) brightness(2)' : 'none' }} />
