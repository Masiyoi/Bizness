    ...
    <div className="fade-up">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 26, flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          <div style={{ fontFamily: 'Jost,sans-serif', fontSize: 12, color: T.grey1, background: T.white, border: `1px solid ${T.grey3}`, borderRadius: 9, padding: '7px 13px', display: 'flex', alignItems: 'center', gap: 6 }}>
            <img src="/registered.png" alt="Registered" style={{ width: 14, height: 14 }}/>
