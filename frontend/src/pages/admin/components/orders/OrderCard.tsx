...
const timeIcon = '/orders/time (1).png';
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 9, marginBottom: 10, flexWrap: 'wrap' }}>
            ...
            <span style={getStatusStyle(o.tracking_status)}>
              <img src={TRACKING_ICON[o.tracking_status] || deliveryIcon} alt="" style={{ width: 11, height: 11, verticalAlign: 'middle', marginRight: 4 }} />{o.tracking_status}
            </span>
          </div>
          ...
          <div className="order-meta-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px,1fr))', gap: 4, marginBottom: preview.length > 0 ? 12 : 0 }}>
            <div style={{ fontFamily: 'Jost,sans-serif', fontSize: 12, color: theme.text }}>
              <img src={userIcon} alt="" style={{ width: 12, height: 12, verticalAlign: 'middle', marginRight: 5 }} /><strong>{o.customer_name || 'Unknown'}</strong>
            </div>
            ...
            {o.mpesa_receipt && (
              ...
              >
                <img src={billIcon} alt="" style={{ width: 12, height: 12, verticalAlign: 'middle', marginRight: 5 }} /><strong style={{ color: '#166534' }}>{o.mpesa_receipt}</strong>
