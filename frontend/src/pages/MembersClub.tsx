...
const memberUpdates: CarouselItem[] = [
...
export default function MembersClub() {
  ...
  const [memberUpdates, setMemberUpdates] = useState<CarouselItem[]>([]);
...
useEffect(() => {
  ...
  const prevSlide = () => setCarouselIndex(i => (i - 1 + memberUpdates.length) % memberUpdates.length);
  const nextSlide = () => setCarouselIndex(i => (i + 1) % memberUpdates.length);
