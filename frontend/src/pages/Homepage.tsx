...
export default function Homepage() {
  ...
  useEffect(() => {
    fetch('https://stunning-space-umbrella-pjgqwxrx5q9vcr77w-5000.app.github.dev/api/products')
      .then(r => r.json())
  ...
  return (
    <div style={{ fontFamily: "'Lora', 'Georgia', serif", background: '#FBF6F0', minHeight: '100vh', color: '#2C1A0E', width: '100%', maxWidth: '100%', overflowX: 'hidden' }}>
      <style>{`
      ...
      <nav style={{
        ...
        boxShadow: '0 2px 16px rgba(44,26,14,0.05)', height: 80,
      }}>
        <img src={logo} alt="A&I Your favorite store" style={{ height:70, width:'auto', objectFit:'contain', filter:'drop-shadow(0 2px 4px rgba(0,0,0,0.12))' }} />
        <div style={{
          ...
          <div style={{
            ...
            {BANNERS.map((_, i) => (
              <div key={i} className="dot"
                ...
                style={{
                  width: i === currentBanner ? 26 : 8, height:8,
                  background: i === currentBanner ? '#fff' : 'rgba(255,255,255,0.45)',
                }}
              />
            ))}
          </div>
          ...
          {CATEGORIES.map(cat => (
            <div
              ...
              style={{
                ...
                boxShadow: activeCategory === cat.label
      ...
      <div style={{ padding:'0 5% 70px' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign:'center', padding:'80px 0', color:'#9C7A60' }}>
            ...
            <p className="sans" style={{ fontSize:13, marginTop:6, color:'#BEA898' }}>
                ...
                <div key={product.id} className="p-card">
                      ...
                      <img
                        ...
                        onError={e => {
                          (e.target as HTMLImageElement).src =
                            'https://placehold.co/300x200/F5EDE3/9C7A60?text=No+Image';
                        }}
                      />
                    </Link>
                    <button
                  ...
                  <div style={{ padding:'14px 16px 16px' }}>
                    ...
                    <button
                      ...
                      style={{
                        background: inCart ? '#2C1A0E' : '#C4703A',
                        color: '#fff',
                      }}
                    >
      ...
      <div style={{
        ...
        <img src={logo} alt="A&I Your favorite store" style={{ height:40, width:'auto', objectFit:'contain', filter:'brightness(0) invert(1)' }} />
